...
if(isset($_POST['find']))
   {
    ...
    $result = mysqli_query($connection, "CALL proc_vouchCal('$Cust_Id')") or die("query fail:" .mysqli_error());

    echo "<table><tr><th>cust_id</th><th>cust_name</th><th>Total_Purchase</th><th>Eligible_Voucher</th></tr>";
    while($row = mysqli_fetch_array($result)){
    echo "<td>" .$row['cust_id']. "</td>";
            echo "<td>" .$row['cust_name']. "</td>";
            echo "<td>" .$row['Total_Purchase']. "</td>";
            echo "<td>" .$row['Eligible_Voucher']. "</td>";
    }
}
?>
</div>
