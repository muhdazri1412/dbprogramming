<html>
            ...
            <div class="container">
                ...
                <div class="topnav">
                    ...
                    <li><a href="itemlist.php">Item List</a></li>
                        ...
                        <li><a class="active" href="find.php">Find</a></li>
    ...
    <center>
            <form action="" method = "POST">
                ...
                <input type="submit" name="find" class="button" value = "find Purchase" />
...
<?php
   ...
   if(isset($_POST['find']))
   {
    ...
    $query = "SELECT c.cust_id, c.cust_name, a.pur_id, b.item_name, a.pur_quantity, a.pur_datepurchase, a.pur_total FROM `Purchase` a
    ...
    $query_run = mysqli_query($connection, $query);
       ...
       if($query_run)
       {
        echo "<table><tr><th>cust_id</th><th>cust_name</th><th>pur_id</th><th>item_name</th><th>pur_quantity</th><th>pur_datepurchase</th><th>pur_total</th></tr>";
